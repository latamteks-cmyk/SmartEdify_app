...
describe('Asset Management Service - E2E Complete Flows', () => {
  ...
  describe('Incident Management Flow', () => {
    ...
    it('should complete the task', () => {
      const updateTaskDto = {
        status: 'completed',
        completion_notes: 'Se encontró desgaste en polea principal. Requiere reemplazo.',
      ...
      return request(app.getHttpServer())
        ...
        .expect((res) => {
          ...
          expect(res.body.completion_notes).toBe(updateTaskDto.completion_notes);
        });
    });
  });
    ...
    it('should create a work order for elevator repair', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect((res) => {
          ...
          expect(res.body.status).toBe(WorkOrderStatus.PENDING);
          expect(res.body.estimated_cost).toBe(1500.00);
