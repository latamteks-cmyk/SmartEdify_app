import { Controller, Post, Body, Get, Param, NotImplementedException, HttpCode, HttpStatus } from '@nestjs/common';
...
export class SessionsController {
  ...
  @Post('subject/revoke')
  @HttpCode(HttpStatus.OK)
  async revokeSubject(@Body('user_id') userId: string, @Body('tenant_id') tenantId: string) {
