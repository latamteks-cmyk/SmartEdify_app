...
export const DatabaseConfig = registerAs('database', () => ({
  ...
  name: process.env.DB_NAME || 'smartedify_assets',
  ssl: process.env.DB_SSL === 'true',
  maxConnections: parseInt(process.env.DB_MAX_CONNECTIONS, 10) || 25,
  ...
  dropSchema: process.env.DB_DROP_SCHEMA === 'true' && process.env.NODE_ENV === 'development',
}));